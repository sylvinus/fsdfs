...
setup(
    ...
    keywords='simple python distributed replicated file system filesystem fs network',
    author='Sylvain Zimmer & contributors',
    author_email='sylvain@sylvainzimmer.com',
    url='https://github.com/sylvinus/fsdfs',
    license='GPLv2',
...
options.setup.package_data=paver.setuputils.find_package_data(
    'fsdfs', package='fsdfs', only_in_packages=False)
